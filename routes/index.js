...
router.get('/', function (req, res) { 
    res.render('index', { title: 'giraffe App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'giraffe App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'giraffe App Login', user : req.user }); 
}); 
